...
enum LaunchAgentManager {
    private static var plistURL: URL {
        FileManager().homeDirectoryForCurrentUser
            .appendingPathComponent("Library/LaunchAgents/\((Bundle.main.bundleIdentifier ?? "ai.openclaw.mac")).plist")
    }
    ...
    private static func writePlist(bundlePath: String) {
        ...
        <dict>
          <key>Label</key>
          <string>\(Bundle.main.bundleIdentifier ?? "ai.openclaw.mac")</string>
